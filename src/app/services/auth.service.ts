...
export class AuthService {
    ...
    public doLogin() {  // opens up the auth window, waits for input for one minute
        ...
        this.intervalId = setInterval(() => {
            if (loopCount-- < 0) {
                ...
                if (href != null) {
                    var re = /access_token=(.*)/; // looks for the words "access token=" in the href of the auth window
